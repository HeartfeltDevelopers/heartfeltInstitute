...
from .models import StudentClasse, OfflineLesson, OnlineLesson, LessonAllocation
...
class LessonAllocationAdmin(admin.ModelAdmin):
    list_display = ["student_root", "course"]


admin.site.register(LessonAllocation, LessonAllocationAdmin)
